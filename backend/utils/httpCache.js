// cache-control for the public, non-personalised reads (the case listings). the data is
...
// case's contents change less often.
const TTL = { caseList: 60, caseDetail: 120 };
