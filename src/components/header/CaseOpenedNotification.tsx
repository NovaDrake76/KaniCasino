      ...
      <div style={{
        ...
        >
          <img
            src={caseImage}
            alt={"case"}
            className="h-20 z-10 object-cover rounded-full p-2 pb-0"
          />
          <div
            className="absolute top-1/2 left-1/2"
            style={{
          ...
          <div className="absolute -bottom-2 flex items-center">
            <img
              ...
              alt={"case"}
              className="w-12 h-12  z-10 object-cover rounded-full p-2"
            />
            <div className="z-10 text-base text-gray-200">{user.name.length > 20 ? `${user.name.slice(0, 20)}...` : user.name}</div>          </div>
        </div>
