        ...
        <div className="flex gap-3">
          <label className="flex flex-col gap-1 flex-1 min-w-0">
            ...
            <input
              ...
              className="w-full min-w-0 bg-surface-nav border border-line focus:border-accent outline-none rounded px-3 py-2 text-sm"
            />
          </label>
          <label className="flex flex-col gap-1 w-24 shrink-0">
            ...
            <input
              ...
              inputMode="numeric"
              value={quantityText}
              onChange={(e) => setQuantityText(digitsOnly(e.target.value, 2))}
              onBlur={() => setQuantityText(String(clampDigits(quantityText, 1, 20, 1)))}
              className="w-full min-w-0 bg-surface-nav border border-line focus:border-accent outline-none rounded px-3 py-2 text-sm"
            />
          </label>
        </div>
